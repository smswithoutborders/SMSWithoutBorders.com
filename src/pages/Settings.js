      ...
      <Container>
        ...
        <div tw="flex flex-col md:flex-row flex-wrap">
          <div tw="flex flex-row md:flex-col w-full md:w-1/3">
            <NavButton active={page === 1} onClick={() => setPage(1)}>
              <FiPlusCircle size={20} tw="mr-2" /> Add Phone Number
            </NavButton>
            <NavButton active={page === 2} onClick={() => setPage(2)}>
              <FiUser size={20} tw="mr-2" /> Change Password
            </NavButton>
            <NavButton active={page === 3} onClick={() => setPage(3)}>
    ...
    <PageAnimationWrapper>
      <div tw="md:border p-4 m-2">
        <div tw="w-full text-gray-800 text-center">
          ...
          <p tw="my-2">
            This action cannot be reversed. Please enter your password to
            confirm
          </p>
        </div>
        ...
        <FormContainer>
          <Form onSubmit={handleSubmit(handleChangePassword)}>
            ...
            <SubmitButton tw="bg-red-900" type="submit">
    ...
    <PageAnimationWrapper>
      <div tw="md:border p-4 m-2">
        <div tw="w-full text-gray-800 text-center">
          ...
          <p tw="my-2">
            Please enter the code sent to you to confirm this operation
          </p>
        </div>
        <FormContainer>
